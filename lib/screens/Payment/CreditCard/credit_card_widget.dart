...
class CreditCardWidget extends StatefulWidget {
  const CreditCardWidget({
    ...
    this.width,
    this.textStyle,
    this.cardBgColor = const Color(0xff2196f3),
...
class _CreditCardWidgetState extends State<CreditCardWidget>
  ...
  Widget getCardTypeIcon(String cardNumber) {
    ...
    switch (detectCCType(cardNumber)) {
      case CardType.visa:
        icon = Image.asset(
          'assets/creditCardIcons/visa.png',
          height: 48,
          width: 48,
        );
        isAmex = false;
      ...
      case CardType.americanExpress:
        icon = Image.asset(
          'assets/creditCardIcons/amex.png',
          height: 48,
          width: 48,
        );
        isAmex = true;
      ...
      case CardType.mastercard:
        icon = Image.asset(
          'assets/creditCardIcons/mastercard.png',
          height: 48,
          width: 48,
        );
        isAmex = false;
      ...
      case CardType.discover:
        icon = Image.asset(
          'assets/creditCardIcons/discover.png',
          height: 48,
          width: 48,
        );
        isAmex = false;
